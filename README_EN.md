...
`RollingGo-MCP` is an MCP (Model Context Protocol) hotel search service.
This document is updated against the latest live `RollingGo-MCP` tool behavior (verified on 2026-02-26).
